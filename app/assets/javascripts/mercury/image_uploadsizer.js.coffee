...
jQuery.extend Mercury.uploadsizer,
  ...
  build: ->
    ...
    @element.append('<div style="font-style:italic;float:right;">("presize" represents the max width and height of an image, in order to save server storage space.)</div>')
    @element.append('<br/><div class="mercury-uploadsizer-select"><div style="font-size:13px"><b>Select Presizing Option:</b></div><br/><input type="radio" name="presizeRadio" value="small" checked> <b>Small</b> (max: 300px)</input><br/><input type="radio" name="presizeRadio" value="medium"> <b>Medium</b> (max: 700px)</input><br/><input type="radio" name="presizeRadio" value="large"> <b>Large</b> (max: 1000px)</input><br/><br/><input type="submit" value="Presize And Upload" name="commit"><br/></div>')
